...
app.get('/api/dashboard', authenticateToken, async (req, res) => {
    try {
        ...
        console.log('Fetching attendance for:', req.user.id, today);
        ...
        console.log('Fetching salary for:', req.user.id);
        ...
        console.log('Fetching overtime for:', req.user.id);
        ...
        console.log('Overtime Results:', overtimeResults);
...
app.get('/api/overtime/history', authenticateToken, async (req, res) => {
    try {
        ...
        const formattedHistory = history.map(record => ({
            ...
            end_time: record.end_time ? new Date(record.end_time).toLocaleTimeString() : null,
            duration: record.duration ? record.duration.toFixed(2) : null,
